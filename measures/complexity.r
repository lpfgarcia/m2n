...
cx.execute = function(name) {
	...
	exe = paste(getwd(), "/dcol/./dcol -i ", getwd(), "/", name, ".arff -o ", getwd(), "/", name, " -F 1 -F 1v -F 2 -F 3 -F 4 -L 1 -L 2 -L 3 -N 1 -N 2 -N 3 -N 4 -T 1", sep="");
...
cx.replace = function(name) {
	...
	exe = paste(getwd(), "/dcol/./dcol -i ", getwd(), "/", name, ".arff -o ", getwd(), "/", name, " -F 1v -L 1 -L 2 -L 3 -d", sep="");
	system(paste(exe, sep=""), ignore.stdout=TRUE, ignore.stderr=TRUE);
